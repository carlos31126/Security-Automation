...
public class securityTestCaseForSystems {
  @Autowired
  ...
  public void testSessionHijacking() throws Exception {
    ...
    try {
    MvcResult loginResult = mockMvc.perform(get("/systems"))
        .andExpect(status().is3xxRedirection())
        .andReturn();
  ...
  public void testSQLInjection() throws Exception {
    ...
    mockMvc.perform(MockMvcRequestBuilders.post("/systems")
  ...
  public void testInvalidJWTtoken() throws Exception {
    ...
    mockMvc.perform(get("/systems").header("Authorization", expiredToken))
    .andExpect(status().isOk());

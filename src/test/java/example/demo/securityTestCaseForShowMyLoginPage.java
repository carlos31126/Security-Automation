...
public class securityTestCaseForShowMyLoginPage {
  @Autowired
  ...
  public void testSessionHijacking() throws Exception {
    MvcResult loginResult = mockMvc.perform(get("/showMyLoginPage"))
  ...
  public void testCsrfProtection() throws Exception {
    MvcResult mvcResult = mockMvc.perform(get("/showMyLoginPage"))
        .andExpect(status().is3xxRedirection())
        .andReturn();
  ...
  public void testMethod123() throws Exception {
    ...
    mockMvc.perform(get("/showMyLoginPage").header("Authorization", expiredToken))
        .andExpect(status().isOk());
  }

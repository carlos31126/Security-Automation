...
public class securityTestCaseForAccessdenied {
  @Autowired
  ...
  public void testSessionHijacking() throws Exception {
    MvcResult loginResult = mockMvc.perform(get("/access-denied"))
  ...
  public void testCsrfProtection() throws Exception {
    MvcResult mvcResult = mockMvc.perform(get("/access-denied"))
        .andExpect(status().is3xxRedirection())
        .andReturn();
  ...
  public void attemptSQLInjectionShouldReturnForbidden1() throws Exception {
    ...
    mockMvc.perform(MockMvcRequestBuilders.post("/access-denied")
  ...
  public void testMethod123() throws Exception {
    ...
    mockMvc.perform(get("/access-denied").header("Authorization", expiredToken))
        .andExpect(status().isOk());
  }
